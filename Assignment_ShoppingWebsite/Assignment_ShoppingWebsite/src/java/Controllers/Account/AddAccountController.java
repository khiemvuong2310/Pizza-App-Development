...
public class AddAccountController extends HttpServlet {
    ...
    private final String SignPage = "SignUp.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (userName != null && password != null && fullName != null) {
                accountId = "C" + String.format("%03d", accountDao.getAccountList().size() + 1);
                ...
                if (accountDao.addAccount(account)) {
                    if (type == null) {
                        ...
                        customerDao.addCustomer(new Customer(accountId, password));
                    }
                    message = "The account ID " + accountId + " has been created successfully";
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
            ...
            request.setAttribute("page", SignPage);
