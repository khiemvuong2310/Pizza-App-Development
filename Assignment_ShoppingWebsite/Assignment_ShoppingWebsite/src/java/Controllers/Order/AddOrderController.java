...
public class AddOrderController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String orderId = "O" + String.format("%03d", orderDao.getOrderList().size() + 1);
            String customerId = a.getAccountId();
            Timestamp orderDate = new Timestamp(System.currentTimeMillis());
            Timestamp requiredDate = new Timestamp(orderDate.getTime() + (30 * 60 * 1000));
            Timestamp shippedDate = new Timestamp(orderDate.getTime() + (30 * 60 * 1000) + (quantity * 5 * 60 * 1000));
            double freight = 5;
